...
@Override
public int selectListCnt(Point point) throws Exception {
	return pointDao.selectListCnt();
}

@Override
public List<Point> list(Point point) throws Exception {
	return pointDao.findAllBy(point);
}
