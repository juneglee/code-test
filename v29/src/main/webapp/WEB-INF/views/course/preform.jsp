  ...
  <div class="statebar">
	...
	<div class="MainContent">
		<div class="leftContent">
		  <div class="coursePlaceArea">
        <div class="coursePlace">
          <div class="coursePlaceLeftArea">
	          <div class="placeBasicbar">
			        <input class="placeName" name="placeNames" type="text" value="" placeholder="장소명"  onchange="inputPlaceName();">
	          </div>
          </div>
          <div class="coursePlaceRightArea">
            <div class="placeAddrbar">
	            <div class="courseBasicAddr">
	              <input class="basicAddr" name="basicAddrs" type="text" value="" placeholder="기본 주소">
	              <input type="button" onChange="getGeoLocation();" onClick="openDaumZipAddress(this);" value = "주소 찾기" />
              </div>
              <div class="courseDetailAddr">
                <input class="detailAddr" name="detailAddrs" type="text" value="">
              </div>
            </div>
          </div>
          <div class="coursePlaceBottomArea">
            <div class="placeEtcbar">
              <input class="etc" name="etcs" type="text" value="">
            </div>
          </div>
        </div>
		  </div>
		  <div id="buttonArea"></div>
				...
				<button type="button" onclick="removeForm()"> 코스 삭제</button>
		  </div>
		  <script>
