      ...
      <c:forEach items="${searchDayList}" var="searchDay">
        <div class="search_repeat">
            <div class="search_repeat_place_photo">
              ...
              <img class="img-thumbnail" src="${pageContext.servletContext.contextPath}/upload/review/day/${searchDay.mainPhoto}" alt="${searchDay.mainPhoto}" 
    ...
    <div class="place_search">
       <c:forEach items="${searchPlaceList}" var="searchPlace">
         <div class="shadow-lg p-3 mb-5 bg-white rounded" style="height: 250px;">
           ...
           <a href='searchPlaceDetail?no=${searchPlace.no}'><img class="img-thumbnail" src="${pageContext.servletContext.contextPath}/upload/review/place/${searchPlace.mainPhoto}" alt="${searchPlace.mainPhoto}"
